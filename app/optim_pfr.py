...
def optim():
    ...
    st.header("Optimized PFR Design")
    ...
    with col1:
        ...
        feed_temp = st.slider("Feed Temperature (K)",
                              min_value=293., max_value=428.15, value=418.57, step=0.01)
        ...
        n_reactor = st.slider("Number of Parallel Reactors",
                              min_value=1, max_value=8, step=1, value=3)
    ...
    with col2:
        ...
        L = st.slider("Reactor Length", min_value=0.1,
                      max_value=25., step=0.01, value=19.867)
        DIAMETER = st.slider("Reactor Diameter", min_value=0.4,
                             max_value=6., step=0.01, value=1.102)
        R = DIAMETER/2
